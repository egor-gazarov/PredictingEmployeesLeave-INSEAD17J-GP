...
Analysis of last evaluation shows that employees that left scored medium and high score during the last evaluation , while employees that stayed are distributed more evenly along the spectrum of medium-high.
...
Analysis of number of projects suggests that the ideal number of project is more than 3 projects per employee. The bulk of employees that left the company had 2 projects only.
...
Analysis of monthly hours suggest that the ideal work hour is between 150-250 hours. There are high concentration of employees that left with work hours lower than 150 hours or higher than 250 hours.
