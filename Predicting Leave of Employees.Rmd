...
#load file with function we'll need to visualize the decision tree
...
Graphical analysis of variables' distributions done on Data Understanding step did not show any suspecious outliers.
...
```{r , echo=TRUE, message=FALSE, warning=FALSE}
#let's also format target variable as factor before dataset separation
...
CrossTable(TestDS$left, PredictionTree, prop.chisq = FALSE, prop.c = FALSE, prop.r = FALSE, dnn = c('actual leave', 'predicted leave'))
```
