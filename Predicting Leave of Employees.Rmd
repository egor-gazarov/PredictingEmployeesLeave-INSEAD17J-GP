...
table(data.deploy1$name,predict.deploy, dnn = c("name","prediction"))
```

The model gave a 'leave' prediction to Jackie, and a 'stay' prediction to Brad and Shahrukh. HR should interpret this data the following way:
